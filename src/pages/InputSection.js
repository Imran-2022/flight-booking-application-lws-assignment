...
import { addToCart } from '../redux/FlightBooking/actions';
...
const InputSection = () => {
  ...
  const handleAddToCart = (e) => {
    e.preventDefault();
    dispatch(addToCart({...values,id:Math.random().toString(16).slice(2)}))
  }

  return (
    <div className="mt-[160px] mx-4 md:mt-[160px] relative">
      <div className="bg-white rounded-md max-w-6xl w-full mx-auto">
        <form className="first-hero lws-inputform" onSubmit={handleAddToCart}>
          {/* <!-- From --> */}
          ...
          <div className="des-from !border-r-0">
            ...
            <div className="flex flex-row">
              ...
              <select className="outline-none px-2 py-2 w-full" name="ticketClass" id="lws-ticketClass" required  onChange={handleChange}>
                <option value="" hidden>Please Select</option>
